 ...
 */
$this->BcAdmin->setTitle(__d('baser_core', 'DubManTopic 編集'));
...
<table class="bca-form-table">
  <tr>
    ...
    <td class="bca-form-table__input">
      <?= $this->BcAdminForm->control('category_id', ['type' => 'hidden', 'value' => $dubManTopic->dub_man_category->id]) ?>
      <?= $dubManTopic->dub_man_category->name ?>
    </td>
  </tr>
  <tr>
    <th class="bca-form-table__label">
